...
outreg2 using FF_pass_2_no_ESG.tex, replace ctitle(Size Portoflios) tex(fragment)
...
outreg2 using  FF_pass_2_no_ESG.tex, append ctitle(Beta Portoflios) tex(fragment)
